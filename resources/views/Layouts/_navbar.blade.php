<header class="main-header">
    ...
    <a href="javascript:void(0);" class="logo">
        ...
        <!-- logo-->
        <div class="logo-lg">
            <span class="dark-logo"><img src="{{ asset('img/logo.png') }}" style="height: 100px" alt="logo"></span>
            <span class="light-logo"><img src="{{ asset('img/logo.png') }}" style="height: 100px" alt="logo"></span>
        </div>
        <div class="logo-mini">
