                            ...
                            <div class="p-30 content-bottom rounded bg-img box-shadowed"
                                ...
                                <div class="row mb-4">
                                    <div class="col-12 text-center">
                                        ...
                                        <h2 class="text-center">Hi, Enter your details to check-in</h2>
                                    </div>
                                </div>
                                <div class="mb-4 pt-4">
                                    {{-- <h4 class="text-dark font-size-30">Get Started<br>with your Dashboard</h4> --}}
                                </div>
                                <form action="{{ url('check_in2') }}" method="POST">
                                    @csrf
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-6 text-center mt-4 mb-4">
                                            <a href="{{ url('/') }}"
                                                class="btn btn-danger btn-block margin-top-10">CANCEL</a>
                                        </div>
                                        <div class="col-6 text-center mt-4 mb-4">
                                            <button type="submit"
                                                class="btn btn-success btn-block margin-top-10">NEXT</button>
                                        </div>
                                        <!-- /.col -->
                                    </div>
                                </form>
